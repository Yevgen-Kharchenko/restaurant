                                                    ...
                                                    <table class="table table-striped table-bordered table-hover">
                                                        ...
                                                        <c:forEach items="${ordersNew}" var="ordersNew">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="order?orderId=${ordersNew.id}"><i class="material-icons">mode_edit</i></a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                        </tbody>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover">
                                                        ...
                                                        <c:forEach items="${ordersInProgress}" var="ordersInProgress">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="order?orderId=${ordersInProgress.id}"><i class="material-icons">mode_edit</i></a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                        </tbody>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover">
                                                        ...
                                                        <c:forEach items="${ordersCompleted}" var="ordersCompleted">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="order?orderId=${ordersCompleted.id}"><i class="material-icons">mode_edit</i></a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                        </tbody>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover">
                                                        ...
                                                        <c:forEach items="${ordersPayment}" var="ordersPayment">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="order?orderId=${ordersPayment.id}"><i class="material-icons">mode_edit</i></a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                        </tbody>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover">
                                                        ...
                                                        <c:forEach items="${ordersClosed}" var="ordersClosed">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="order?orderId=${ordersClosed.id}"><i class="material-icons">mode_edit</i></a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                        </tbody>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover">
                                                        ...
                                                        <c:forEach items="${ordersCanceled}" var="ordersCanceled">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="order?orderId=${ordersCanceled.id}"><i class="material-icons">mode_edit</i></a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                        </tbody>
