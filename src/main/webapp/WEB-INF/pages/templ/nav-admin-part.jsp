...
<div class="sidebar-collapse">
    <ul class="nav" id="main-menu">
        ...
        <li>
            <a href="errors/under-construction" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> Multi-Level Dropdown<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
                <li>
                    <a href="errors/under-construction">Second Level Link</a>
                </li>
                <li>
                    <a href="errors/under-construction">Second Level Link</a>
                </li>
                <li>
                    <a href="errors/under-construction">Second Level Link<span class="fa arrow"></span></a>
                    <ul class="nav nav-third-level">
                        <li>
                            <a href="errors/under-construction">Third Level Link</a>
                        </li>
                        <li>
                            <a href="errors/under-construction">Third Level Link</a>
                        </li>
